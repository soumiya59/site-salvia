...
import { menuItems, pagesItems, portfolioItems, blogItems, } from "../../data/menu";
import { isActiveLink, isActiveParent, isActiveParentChaild, } from "../../utils/linkActiveChecker";
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          ...
          {/* End li (home mega menu) */}
            ...
            <Link href="/pages-menu/about-us-v1" className="nav-item ">
              <p className="nav-link"> About </p>
            </Link>
            <Link href="/pages-menu/service-v1" className="nav-item ">
